...
3. Read all `docs/recap_context/daily/YYYY/YYYY-MM-DD.md` files from Monday to today
4. Generate weekly report
5. Write to `docs/recap_context/weekly/YYYY/YYYY-WXX.md` (XX = ISO week number)
